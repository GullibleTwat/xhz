...
namespace Maticsoft.SQLServerDAL
{
	...
	/// 数据访问类:WorksItem
	/// </summary>
	public partial class WorksItem:IWorksItem
	{
		public WorksItem()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("No", "WorksItem"); 
		}
		...
		public bool Exists(int No,int ID)
		{
			...
			strSql.Append("select count(1) from WorksItem");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WorksItem ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Title,No ");
			strSql.Append(" FROM WorksItem ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WorksItem T ");
