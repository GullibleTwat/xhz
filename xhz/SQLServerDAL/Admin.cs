...
namespace Maticsoft.SQLServerDAL
{
	...
	public partial class Admin:IAdmin
	{
		...
		public bool Add(Maticsoft.Model.Admin model)
		{
			...
			strSql.Append("ID,Passwd,Power)");
			strSql.Append(" values (");
			strSql.Append("@ID,@Passwd,@Power)");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.NVarChar,10),
					new SqlParameter("@Passwd", SqlDbType.NVarChar,50),
		...
		public bool Update(Maticsoft.Model.Admin model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@Power", SqlDbType.Int,4),
					new SqlParameter("@ID", SqlDbType.NVarChar,10)};
			parameters[0].Value = model.Passwd;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Admin GetModel(string ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Passwd,Power from Admin ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.NVarChar,10)			};
			parameters[0].Value = ID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Passwd,Power ");
