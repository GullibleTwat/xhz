<%@ Page Title="Works" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Works.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Attachment" HeaderText="附件" SortExpression="Attachment" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ItemID" HeaderText="分类" SortExpression="ItemID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="GroupID" HeaderText="分组" SortExpression="GroupID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="IsOpen" HeaderText="是否显示" SortExpression="IsOpen" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="S2" HeaderText="备用2" SortExpression="S2" ItemStyle-HorizontalAlign="Center"  /> 
