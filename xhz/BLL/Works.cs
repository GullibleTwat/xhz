...
namespace Maticsoft.BLL
{
	...
	{
		private readonly IWorks dal=DataAccess.CreateWorks();
		public Works()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.Works GetModelByCache(int No)
		{
			
			string CacheKey = "WorksModel-" + No;
			...
			return (Maticsoft.Model.Works)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Works> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Works> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.Works> modelList = new List<Maticsoft.Model.Works>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Works model;
