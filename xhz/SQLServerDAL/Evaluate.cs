...
namespace Maticsoft.SQLServerDAL
{
	...
	/// 数据访问类:Evaluate
	/// </summary>
	public partial class Evaluate:IEvaluate
	{
		public Evaluate()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("No", "Evaluate"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.Evaluate model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Evaluate(");
			strSql.Append("Title,Content,Attachment,Time,IsOpen,GroupID,Click,No,Mark,S1)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.Evaluate model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Evaluate GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Title,Content,Attachment,Time,IsOpen,GroupID,Click,No,Mark,S1 from Evaluate ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.Evaluate model=new Maticsoft.Model.Evaluate();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Evaluate DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Evaluate model=new Maticsoft.Model.Evaluate();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Title,Content,Attachment,Time,IsOpen,GroupID,Click,No,Mark,S1 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Title,Content,Attachment,Time,IsOpen,GroupID,Click,No,Mark,S1 ");
			strSql.Append(" FROM Evaluate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
