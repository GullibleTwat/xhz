...
namespace Maticsoft.SQLServerDAL
{
	...
	/// 数据访问类:EvaluateGroup
	/// </summary>
	public partial class EvaluateGroup:IEvaluateGroup
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("No", "EvaluateGroup"); 
		}
		...
		public bool Exists(int No,int ID)
		{
			...
			strSql.Append("select count(1) from EvaluateGroup");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.EvaluateGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into EvaluateGroup(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.EvaluateGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update EvaluateGroup set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from EvaluateGroup ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.EvaluateGroup GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Title,Atlas,Time,Info,No,Mark,Click from EvaluateGroup ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.EvaluateGroup model=new Maticsoft.Model.EvaluateGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.EvaluateGroup DataRowToModel(DataRow row)
		{
			Maticsoft.Model.EvaluateGroup model=new Maticsoft.Model.EvaluateGroup();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM EvaluateGroup ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from EvaluateGroup T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "EvaluateGroup";
			parameters[1].Value = "ID";
